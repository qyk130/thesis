...
Kingma et al.\cite{kingmaadam} proposed Adaptive Moment Estimation(Adam), a stochastic gradient based optimization algorithm at 2015. Adam calculates adaptive learning rates for each parameter based on estimates of first and second moments of the gradients.
